...
#    - Supports: Claude, Gemini, Copilot, Cursor, Qwen, opencode, Codex, Windsurf, Junie, Kilo Code, Auggie CLI, Roo Code, CodeBuddy CLI, Qoder CLI, Amp, SHAI, Tabnine CLI, Kiro Code, AmazonQ, Augy Code, IBM Bob, Mistral Vibe, Kimi Code, Trae, Pi Coding Agent, iFlow CLI, Forge, Antigravity or Generic
#    - Can update single agents or all existing agent files
#    - Creates default Claude file if no agent files exist
#
# Usage: ./update-agent-context.sh [agent_type]
# Agent types: claude|gemini|copilot|cursor-agent|qwen|opencode|codex|windsurf|junie|kilocode|auggie|roo|codebuddy|amp|shai|tabnine|kiro-cli|agy|amazonq|bob|vibe|qodercli|kimi|trae|pi|iflow|forge|generic
...
AMAZONQ_FILE="$REPO_ROOT/AMAZONQ.md"
...
update_specific_agent() {
    ...
    case "$agent_type" in
        ...
        agy)
            ...
            ;;
        amazonq)
            update_agent_file "$AMAZONQ_FILE" "Amazon Q" || return 1
            ;;
        bob)
        ...
        iflow)
            ...
            ;;
        forge)
            update_agent_file "$FORGE_FILE" "Forge" || return 1
            ;;
        generic)
        ...
        *)
            ...
            log_error "Expected: claude|gemini|copilot|cursor-agent|qwen|opencode|codex|windsurf|junie|kilocode|auggie|roo|codebuddy|amp|shai|tabnine|kiro-cli|agy|amazonq|bob|vibe|qodercli|kimi|trae|pi|iflow|forge|generic"
            exit 1
            ;;
    esac
}
...
update_all_existing_agents() {
    ...
    _update_if_new "$AMAZONQ_FILE" "Amazon Q"               || _all_ok=false
...
print_summary() {
    ...
    echo
    log_info "Usage: $0 [claude|gemini|copilot|cursor-agent|qwen|opencode|codex|windsurf|junie|kilocode|auggie|roo|codebuddy|amp|shai|tabnine|kiro-cli|agy|amazonq|bob|vibe|qodercli|kimi|trae|pi|iflow|forge|generic]"
}
